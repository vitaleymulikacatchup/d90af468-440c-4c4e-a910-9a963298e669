    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroSplit
          ...
          description="Passionate about creating modern, responsive web applications with 5+ years of experience in React, Next.js, TypeScript, and cutting-edge web technologies."
          tag="Welcome"
          tagIcon={Code2}
          imagePosition="right"
          ...
          imageAlt="Professional developer workspace"
          buttons={[
            {
              text: "View Portfolio",
              href: "/portfolio"
